...
Education has always moved at a fixed pace. A teacher covers a chapter in two weeks. The class writes an exam on a set date. Some learners are ready in week one. Others need three months. Everyone waits for the same calendar regardless.

This creates two problems. Fast learners get bored and disengage. Slower learners feel left behind and give up. Neither gets what they actually need: content at the right speed, in the right format, at the right time.
...
Select from fields like Language, Mathematics, and Engineering. Drill down to the subject and topic that matters to you. Everything is organised the way your school curriculum organises it.

**2. Work through a roadmap.**
Each topic is structured as a roadmap — a series of lessons and checkpoints, like levels in a game. You unlock each level by completing the one before it. There's no skipping ahead, which means no shaky foundations.

**3. Study and test yourself.**
...
**South African first.** IsiZulu is a first-class language in My Backpack, not an afterthought. Content aligns to CAPS and IEB curricula, not to British or American syllabi. The context — the examples, the language, the rewards — is South African.

**The testing centre pathway.** My Backpack is the only learning app that connects digital learning directly to physical, formal assessments. You learn online, at your pace, and write your exam in person when you're ready.
...
- Question generation — non-AI questions generated automatically, AI questions via Anthropic Claude
